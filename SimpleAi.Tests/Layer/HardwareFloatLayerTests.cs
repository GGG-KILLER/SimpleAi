...
public class HardwareFloatLayerTests
{
    ...
    {
        // @formatter:off
        Layer<float, T> layer = new Layer<float, T>(Tensor.Create([
        ...
        var output = layer.RunInference(
            (float[]) [49f, 50f, 51f, 52f, 53f, 54f, 55f, 56f, 57f, 58f, 59f, 60f, 61f, 62f, 63f, 64f, 2f,]);
