...
/// <summary>Slide the view to the right to keep the newest data points in view</summary>
internal class ConstantSlide : IAxisLimitManager
{
    /// <summary>Amount of horizontal area to display (in axis units)</summary>
    public double Width { get; set; } = 1000;

    /// <summary>
    ///     Defines the amount of whitespace added to the right of the data when data runs outside the current view. 0 for
    ///     a view that slides every time new data is added 1 for a view that only slides forward when new data runs off the
    ///     screen
    /// </summary>
    public double PaddingFractionX { get; set; } = 0;

    /// <summary>
    ///     Defines the amount of whitespace added to the top or bottom of the data when data runs outside the current
    ///     view. 0 sets axis limits to tightly fit the data height 1 sets axis limits to double the vertical span in the
    ///     direction of the vertical overflow
    /// </summary>
